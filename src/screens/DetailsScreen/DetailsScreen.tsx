...
export function DetailsScreen({ navigation }: Props) {
	...
	// Adding an orientation listener and removing it on unmount
	// For a youtube like feature to open the player when the user rotates the phone
	useEffect(() => {
				...
				<DetailsWrapper>
					<Layout.Block direction="row" align="center" flex={1} justify="space-between">
						<Layout.Block direction="row" align="center" flex={1}>
							{/* TITLE */}
							<Typography.H4 color="white" weight="bold" style={{ marginRight: 10 }}>
								{itemToView?.title}
							</Typography.H4>
